...
{
    [Serializable]
    public class TaylorVortexScene : MonoBehaviour
    {
        void Start()
        {
            ...
            m_XYZMax = new Vector3(2 * CGlobalMacroAndFunc.M_PI, 2 * CGlobalMacroAndFunc.M_PI, 1);
            ...
            m_EulerFluid.setVelocityField(m_TaylorVortex.getVelField());
