...
{
    public class CVortexCollisionSmokeEmitter
    {
        public CVortexCollisionSmokeEmitter()
        {
        ...
        public CVortexCollisionSmokeEmitter(int vEmitteStartFrame, int vEmitteEndFrame, float vEmittedensity, float vEmitteTemperature, Vector3 vEmitterInitialPos, EmitteVelFunc vEmitteVelFunc = null, EmitterVelFunc vEmitterVelFunc = null)
        {
            ResizeVortexCollisionSmokeEmitter(vEmitteStartFrame, vEmitteEndFrame, vEmittedensity, vEmitteTemperature, vEmitterInitialPos, vEmitteVelFunc, vEmitterVelFunc);
        }

        public void ResizeVortexCollisionSmokeEmitter(int vEmitteStartFrame, int vEmitteEndFrame, float vEmittedensity, float vEmitteTemperature, Vector3 vEmitterInitialPos, EmitteVelFunc vEmitteVelFunc = null, EmitterVelFunc vEmitterVelFunc = null)
        {
        ...
        public void emitteSmoke(int vCurSimulationFrame, float vDeltaT, CCellCenteredScalarField voDensityField1, CCellCenteredScalarField voDensityField2, CCellCenteredScalarField voTemperatureField, CFaceCenteredVectorField voVelField)
        {
            ...
            {
                CSmokeEmitterInvoker.emitteVortexCollisionDensityAndTemperatureInvoker(m_Emittedensity, m_EmitteTemperature, voDensityField1, voTemperatureField, true);
                CSmokeEmitterInvoker.emitteVortexCollisionDensityAndTemperatureInvoker(m_Emittedensity, m_EmitteTemperature, voDensityField2, voTemperatureField, false);
                CSmokeEmitterInvoker.emitteVortexCollisionVelInvoker(voVelField);
            }
        }
