...
{
    public class CTaylorVortex
    {
        public CTaylorVortex(Vector3Int vResolution, Vector3 vOrigin, Vector3 vSpacing)
        {
            resizeTaylorVortex(vResolution, vOrigin, vSpacing);
        }

        public void resizeTaylorVortex(Vector3Int vResolution, Vector3 vOrigin, Vector3 vSpacing)
        {
        ...
        public void initTaylorVortexVelField(float vDistance)
        {
            __buildMatrixA();
            __generateCurlField(vDistance);
            __buildRhs();
        ...
        private void __generateCurlField(float vDistance)
        {
            CTaylorVortexInvoker.generateCurlFieldInvoker(m_CurlField.getResolution(), m_Origin, m_Spacing, m_CurlField.getGridData(), vDistance);
